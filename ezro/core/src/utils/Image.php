...
//        imagejpeg($image_thumb);
     ...
     * @return bool
     */
    public function saveJpeg($path,$new_name){
        imagejpeg($this->image,$path.$new_name.'.jpeg');
        return $new_name.'.jpeg';
    }
     ...
     * @return bool
     */
    public function savePng($path,$new_name){
        imagepng($this->image,$path.$new_name.'.png');
        return $new_name.'.png';
    }
